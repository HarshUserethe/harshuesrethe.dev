...
const MyProcess = ({ autoScrollInterval = 5000 }) => {
  ...
  const steps = [
    {
      ...
      title: 'Research',
      description:
        'Understanding the problem, one step at a time. Deep dive into details.',
    ...
    },
    {
      ...
      title: 'Development',
      description:
        'The design may be Lunal but it needs to be functional and practical. Development is key.',
      icon: LuCode,
    },
    {
      id: '05',
      ...
      description:
        'Website load times, SEO, optimization, etc., well-tested quality of the site.',
      icon: LuShield,
    },
  ];
  ...
  useEffect(() => {
    if (scrollContainerRef.current) {
      ...
      const cardWidth =
        container.querySelector('.process-card')?.offsetWidth || 0;
                ...
                >
                  <Box className="card-content">
                    <Box
                      ...
                      sx={{ background: styles?.mainTheme?.mdpIconWrapper }}
                    >
                      <IconComponent
